...
export class AddedPostsViews1689772484843 implements MigrationInterface {
    name = 'AddedPostsViews1689772484843'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "lastOnline" SET DEFAULT '"2023-07-19T13:14:45.841Z"'`);
